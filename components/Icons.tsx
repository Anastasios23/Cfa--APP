...
export const UsersIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663c.231.006.462.01.692.011a6.375 6.375 0 015.69-4.544c.489.201.954.448 1.372.738M12 12H9m3 0v3m0-3h3m-3 0V9"
    />
  </svg>
);
...
export const ListBulletIcon: React.FC<{ className?: string }> = ({
  className = "w-6 h-6",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
